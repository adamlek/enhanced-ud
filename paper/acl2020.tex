...
patterns. We show that with a simple method we are able to achieve
strong performance for enhanced edges, and varying performance for the
label enhancements. For the official test data our ELAS score is
$67.85$ and our EULAS score is $80.18$. We analyse our system and find
key problems related to case marking that are responsible for some of
the label errors.  Additionally, we show that much of the information
needed to construct EUD graphs from UD trees are present in the UD
trees, and identify which phenomena require additional attention.
\end{abstract}
