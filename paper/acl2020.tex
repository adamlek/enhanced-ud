...
results in a small loss in performance across the board \todo{can we
...
\item Our graph-to-tree transformation works well on the gold trees,
  ...
  same for both sentence \todo{optional: UD tree for "She was cleaning and eating fruits"?}.  (And thus, our algorithm
